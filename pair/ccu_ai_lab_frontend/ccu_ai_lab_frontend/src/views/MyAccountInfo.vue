...
import { getUserInfo, editUser, getAllResearch } from "../service/api.js";
...
export default {
    ...
    onSubmit() {
      editUser(
        ...
        .then(response => {
          ...
          alert("Your account's information has been changed.");
  ...
  created() {
    getUserInfo(localStorage.getItem("id")).then(response => {
