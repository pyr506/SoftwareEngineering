<template>
  <div>
    ...
    <div class="contentBox">
      ...
      2. Click Reset Password button.<br>
      3. Reset Password mail will be sent to your e-mail, please check your mailbox.<br>
      *Note: Please check your <font style="color: red">SPAM mailbox</font> if you did not receive Reset Password mail.
      <br>
      <br>
      <b-form v-if="show">
      ...
      resetpassword(this.form.email)
        .then((resp) => {
          if (resp.status == "error") {
            ...
            alert("Reset Password Success: Reset Password mail has been resent to your e-mail, please check your mailbox, thank you.");
          }
        })
        .catch((error) => {
