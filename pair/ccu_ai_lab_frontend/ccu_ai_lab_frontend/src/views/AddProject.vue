<template>
  <div>
    ...
    <div class="contentBox">
      <b-form>
        <div class="text-center" style="padding-bottom: 20px;">Applier Infomation</div>
        <div class="row">
          <div class="col">
            <b-form-group id="input-group-2" label="Name of PI:" label-for="input-2">
              <b-form-input id="input-2" v-model="form.name_of_pi" type="text" required></b-form-input>
            </b-form-group>
          </div>
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            <b-form-group id="input-group-2" label="University:" label-for="input-2">
              <b-form-input id="input-2" v-model="form.university" type="text" required></b-form-input>
            </b-form-group>
          </div>
          <div class="col">
            <b-form-group id="input-group-3" label="Department:" label-for="input-3">
              <b-form-input id="input-3" v-model="form.department" type="text" required></b-form-input>
            </b-form-group>
          </div>
        </div>
        <div class="text-center" style="padding: 20px;">Project Infomation</div>
        <b-form-group id="input-group-1" label="Title of your project:" label-for="input-1">
          <b-form-input id="input-1" v-model="form.project_title" type="text" required></b-form-input>
        </b-form-group>
        <b-form-group id="input-group-1" label="Links:" label-for="input-1">
          <b-form-input id="input-1" v-model="form.link" type="url" required></b-form-input>
        </b-form-group>
        <div class="row">
          <div class="col">
            <b-form-group id="input-group-1" label="Start Date:" label-for="startdate">
              <b-form-datepicker id="startdate" v-model="form.start_date" class="mb-2"></b-form-datepicker>
            </b-form-group>
          </div>
          <div class="col">
            <b-form-group id="input-group-1" label="End Date:" label-for="enddate">
              <b-form-datepicker id="enddate" v-model="form.end_date" class="mb-2"></b-form-datepicker>
            </b-form-group>
          </div>
        </div>
        <b-form-group id="input-group-1" label="Apply CO-PI End Date:" label-for="applycopienddate">
          <b-form-datepicker id="applycopienddate" v-model="form.apply_copi_end_date" class="mb-2"></b-form-datepicker> 
        </b-form-group>
        <b-form-group id="input-group-4" label="Content:" label-for="textarea">
...
<script>
import { newProject, getAllResearch } from "../service/api.js";
import Multiselect from "vue-multiselect";
import ViewTitle from "../components/ViewTitle.vue";
import TinymceEditor from '../components/TinymceEditor.vue'

export default {
  components: { Multiselect, ViewTitle, TinymceEditor },
  data() {
    return {
      form: {
        project_title: "",
        ...
        department: "",
        link: "",
        start_date: this.setToday(),
        end_date: this.setToday(),
        apply_copi_end_date: this.setToday(),
        project_content: ""
      },
  ...
  methods: {
    onSubmit() {
      newProject(
        ...
        this.form.name_of_pi,
        this.form.department,
        this.form.project_title,
        this.form.link,
        this.form.start_date,
        this.form.end_date,
        this.form.apply_copi_end_date,
        ...
        .then(response => {
          ...
          alert("Add Project Success: " + this.form.project_title);
